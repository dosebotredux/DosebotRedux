...
exports.run = (client, message, args) => {
  ...
  const embed = new Discord.RichEmbed()
    ...
    .addField(
      ...
      It was created by <@278301453620084736> with assistance from <@295422447887450114>, <@247965158364676104>, and <@183993728178978818>, with the goal of raising awareness of harm reduction best practices, as well as the Subjective Effect Index. For a complete list of commands type \'--help\'.
